...
| trust | 意味 | 例 |
|-------|------|-----|
| `trusted` | 内部データ。安全に利用してよい | search_memory、read_memory_file、write_memory_file、archive_memory_file、skill、add_task、update_task、list_tasks、post_channel、send_message、create_anima、disable_subordinate、enable_subordinate、set_subordinate_model、restart_subordinate、call_human、recent_outbound |
